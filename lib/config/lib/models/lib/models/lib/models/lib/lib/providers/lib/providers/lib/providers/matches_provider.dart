...
class MatchesProvider extends ChangeNotifier {
    ...
    try {
      ...
      if (index != -1) {
        ...
        final updatedMatch = Match(
          ...
          oddsX: match.oddsX,
          odds2: match.odds2,
          oddsOver25: match.oddsOver25,
          oddsUnder25: match.oddsUnder25,
        );
        _upcomingMatches[index] = updatedMatch;
        _finishedMatches.add(updatedMatch);
        notifyListeners();
      }
    } catch (e) {
  ...
  Match? getMatchById(String matchId) {
    try {
      return _upcomingMatches.firstWhere((m) => m.id == matchId);
    } catch (e) {
      return null;
    }
  }
